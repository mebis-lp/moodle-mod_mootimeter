...
/**
 * Helper class to handle inplace edit of phrases.
 *
...
namespace mootimetertool_ranking\local;
...
class inplace_edit_answer extends \core\output\inplace_editable {
    ...
    public function __construct(object $page, object $answer) {
        ...
        $instance = $ranking::get_instance_by_pageid($page->id);
        $cm = $ranking::get_cm_by_instance($instance);
        ...
        parent::__construct(
            ...
            format_string($answer->{$ranking::ANSWER_COLUMN}),
            $answer->{$ranking::ANSWER_COLUMN}
        );
    }
